...
7. ที่หัวข้อ `Artifacts` กดดาวน์โหลด `Check_Tag_RS_v0.12_APK`
8. แตก ZIP ที่ดาวน์โหลด จะได้ `Check_Tag_RS_v0.12.apk` สำหรับติดตั้งบน PM75
